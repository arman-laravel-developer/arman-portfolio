...
<head>
    ...
    <title>ARMAN - Laravel Web Developer</title>
    <meta name="description" content="ARMAN - Laravel Web Developer">
                ...
                <div class="menu-container">
                    <div class="logo">
                        <a class="navbar-brand me-0" href="{{route('home')}}">
                            ...
                            <span>Arman<span class="primary">Portfolio</span></span>
                        </a>
                    </div>
                        ...
                        <div class="card profile-card">
                            <div class="card-body">
                                <div class="image text-center">
                                    <img src="{{asset('/')}}front/assets/img/arman.jpg" alt="profile">
                                </div>
                                <div class="text">
                                    <h3 class="card-title">Md Arman Ali 👋</h3>
                                        ...
                                        <div class="work-experiance-main">
                                            <ul class="work-experiance-slider list-unstyled">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        <div class="icon">
                                                            <img src="{{asset('/')}}front/assets/img/icons/google.svg" alt="google">
                                                        </div>
                                                        <div class="text">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="info">
                                                        <div class="icon">
                                                            <img src="{{asset('/')}}front/assets/img/icons/meta.svg" alt="meta">
                                                        </div>
                                                        <div class="text">
                                        ...
                                        <div class="expertise-main mt-24">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                                    <div class="expertise-item">
                                                        <div class="image text-center">
                                                            <img src="{{asset('/')}}front/assets/img/icons/mico.svg" alt="micro">
                                                        </div>
                                                        <div class="text">
                                    ...
                                    <div class="row g-4 parent-container">
                                        <div class="col-lg-12">
                                            <div class="project-item">
                                                <div class="image">
                                                    <img src="{{asset('/')}}front/assets/img/projects/project-1.png" alt="project-1" class="img-fluid w-100">
                                                    <a href="{{asset('/')}}front/assets/img/projects/project-1.png"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="project-item">
                                                <div class="image">
                                                    <img src="{{asset('/')}}front/assets/img/projects/project-2.png" alt="project-2" class="img-fluid w-100">
                                                    <a href="{{asset('/')}}front/assets/img/projects/project-2.png"
                                                       class="gallery-popup full-image-preview parent-container">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none"
                                                             stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                                            <path d="M10 4.167v11.666M4.167 10h11.666"></path>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-3 col-sm-6 col-6">
                                                <div class="services-item text-center">
                                                    <div class="image">
                                                        <img src="{{asset('/')}}front/assets/img/icons/ui-ux.svg" alt="ui-ux">
                                                    </div>
                                                    <div class="text">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-6">
                                                <div class="services-item text-center">
                                                    <div class="image">
                                                        <img src="{{asset('/')}}front/assets/img/icons/app.svg" alt="app">
                                                    </div>
                                                    <div class="text">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-6">
                                                <div class="services-item text-center">
                                                    <div class="image">
                                                        <img src="{{asset('/')}}front/assets/img/icons/branding.svg" alt="branding">
                                                    </div>
                                                    <div class="text">
