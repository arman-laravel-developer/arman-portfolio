    ...
    <div class="col-xl-8">
        <div class="card content-box-card">
            <div class="card-body">
                <div class="top-info">
                    <div class="text">
                        <h1 class="main-title">Hi, This Is <span>Md Arman Ali</span> 👋</h1>
                        <p>A Passionate <b>Full Stack Developer</b> 🖥️ & <b>Cyber Security Specialist</b> having <b>5
                        years</b> of Experiences over 24+
                            Country Worldwide.</p>
                    </div>
                ...
                <div class="counter-area">
                    ...
                    <div class="circle-area">
                        <div class="circle-text">
                            <img class="circle-image" src="{{asset('/')}}front/assets/img/about-us/circle-text.svg" alt="circle-text">
                            <img class="circle-image circle-image-light d-none"
                                 src="{{asset('/')}}front/assets/img/about-us/circle-text-light.svg" alt="circle-text">
...
{{--                        <div class="items">--}}
{{--                            <img src="{{asset('/')}}front/assets/img/icons/notion.svg" alt="notion">--}}
{{--                        </div>--}}
{{--                        <div class="items">--}}
{{--                            <img src="{{asset('/')}}front/assets/img/icons/webflow.svg" alt="webflow">--}}
{{--                        </div>--}}
{{--                        <div class="items">--}}
{{--                            <img src="{{asset('/')}}front/assets/img/icons/mico.svg" alt="mico">--}}
{{--                        </div>--}}
{{--                        <div class="items">--}}
{{--                            <img src="{{asset('/')}}front/assets/img/icons/framer.svg" alt="framer">--}}
{{--                        </div>--}}
{{--                        <div class="items">--}}
{{--                            <img src="{{asset('/')}}front/assets/img/icons/zeplin.svg" alt="zeplin">--}}
{{--                        </div>--}}
{{--                        <div class="items">--}}
{{--                            <img src="{{asset('/')}}front/assets/img/icons/figma.svg" alt="figma">--}}
{{--                        </div>--}}
{{--                        <div class="items">--}}
{{--                            <img src="{{asset('/')}}front/assets/img/icons/notion.svg" alt="notion">--}}
{{--                        </div>--}}
...
{{--                                            <div class="icon">--}}
{{--                                                <img src="{{asset('/')}}front/assets/img/icons/adobe.svg" alt="adobe">--}}
{{--                                            </div>--}}
{{--                                            <div class="text">--}}
...
{{--                                        <div class="award-name">--}}
{{--                                            <div class="icon">--}}
{{--                                                <img src="{{asset('/')}}front/assets/img/icons/dribbble.svg" alt="dribbble">--}}
{{--                                            </div>--}}
{{--                                            <div class="text">--}}
...
{{--                                        <div class="award-name">--}}
{{--                                            <div class="icon">--}}
{{--                                                <img src="{{asset('/')}}front/assets/img/icons/awwwards.png" alt="awwwards">--}}
{{--                                            </div>--}}
{{--                                            <div class="text">--}}
...
{{--                                        <div class="award-name">--}}
{{--                                            <div class="icon">--}}
{{--                                                <img src="{{asset('/')}}front/assets/img/icons/behance.svg" alt="behance">--}}
{{--                                            </div>--}}
{{--                                            <div class="text">--}}
                        ...
                        <div class="row article-publications-slider">
                                ...
                                <div class="article-publications-item">
                                    <div class="image">
                                        <a href="article.html" class="d-block w-100">
                                            <img src="{{asset('/')}}front/assets/img/blog/blog-img-1.jpg" alt="blog-img-1" class="img-fluid w-100">
                                        </a>
                            ...
                            <div class="col-lg-6">
                                <div class="article-publications-item">
                                    <div class="image">
                                        <a href="article.html" class="d-block w-100">
                                            <img src="{{asset('/')}}front/assets/img/blog/blog-img-2.jpg" alt="blog-img-2" class="img-fluid w-100">
                                        </a>
                                        <a href="article.html" class="tags">Development</a>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-lg-6">
                                <div class="article-publications-item">
                                    <div class="image">
                                        <a href="article.html" class="d-block w-100">
                                            <img src="{{asset('/')}}front/assets/img/blog/blog-img-3.jpg" alt="blog-img-3" class="img-fluid w-100">
                                        </a>
                                        <a href="article.html" class="tags">Development</a>
                                    </div>
                                    <div class="text">
                ...
                <div class="work-together-slider">
                    <div class="slider-main d-flex gap-4 align-items-center">
                        <div class="slider-item">
                            <a href="{{route('contact.us')}}">Let's 👋 Work Together</a>
                            <a href="{{route('contact.us')}}">Let's 👋 Work Together</a>
                        </div>
                        <div class="slider-item">
                            <a href="{{route('contact.us')}}">Let's 👋 Work Together</a>
