                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-4 col-md-6">
                                <div class="article-publications-item">
                                    <div class="image">
                                        <a href="article.html" class="d-block w-100">
                                            <img src="{{asset('/')}}front/assets/img/blog/blog-img-4.jpg" alt="blog-img-4" class="img-fluid w-100">
                                        </a>
                                        <a href="article.html" class="tags">Development</a>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-xl-6 col-lg-4 col-md-6">
                                <div class="article-publications-item">
                                    <div class="image">
                                        <a href="article.html" class="d-block w-100">
                                            <img src="{{asset('/')}}front/assets/img/blog/blog-img-5.jpg" alt="blog-img-5" class="img-fluid w-100">
                                        </a>
                                        <a href="article.html" class="tags">Development</a>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-xl-6 col-lg-4 col-md-6">
                                <div class="article-publications-item">
                                    <div class="image">
                                        <a href="article.html" class="d-block w-100">
                                            <img src="{{asset('/')}}front/assets/img/blog/blog-img-6.jpg" alt="blog-img-6" class="img-fluid w-100">
                                        </a>
                                        <a href="article.html" class="tags">Development</a>
                                    </div>
                                    <div class="text">
